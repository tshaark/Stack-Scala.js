...
$c_Ltutorial_webapp_TutorialApp$.prototype.Pop__V = (function() {
  this.delPar__Lorg_scalajs_dom_raw_Node__V($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().body)
});
$c_Ltutorial_webapp_TutorialApp$.prototype.Push__V = (function() {
  this.appendPar__Lorg_scalajs_dom_raw_Node__T__V($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().body, $as_T($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("num-input").value))
});
$c_Ltutorial_webapp_TutorialApp$.prototype.delPar__Lorg_scalajs_dom_raw_Node__V = (function(targetNode) {
  var stack = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("stack-div");
...
$c_Ltutorial_webapp_TutorialApp$.prototype.appendPar__Lorg_scalajs_dom_raw_Node__T__V = (function(targetNode, text) {
  var parNode = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement("tr");
  var textNode = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createTextNode(text);
  parNode.appendChild(textNode);
  var stack = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("stack-div");
  stack.insertBefore(parNode, stack.childNodes[0])
});
...
$e.Pop = (function() {
  $m_Ltutorial_webapp_TutorialApp$().Pop__V()
});
$e.Push = (function() {
  $m_Ltutorial_webapp_TutorialApp$().Push__V()
});
$m_Ltutorial_webapp_TutorialApp$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
//# sourceMappingURL=stack-fastopt.js.map
